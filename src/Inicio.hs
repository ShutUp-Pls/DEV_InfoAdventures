...
estadoInicial isTutorial = do
    ...
    let spawnersBuffs    = [ spawnerTiempoA, spawnerTiempoB, spawnerTiempoC
    ...
    let glockInicial = OArma.crearItemArma OArma.idArmGlock (SDL.V2 0 0)
